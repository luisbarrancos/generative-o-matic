/*
    Game class for CFD interactive simulation.
...
class Game
{
    ...
    add(id, min_frequency = 20, max_frequency = 200)
    {
        this.players[id]       = {};
        ...
        // create oscillators array from frequency assigned, per harmonic
        ...
        // finally update the ID and harmonics
        this.id++;
        this.numPlayers++;
        this.harmonic++;
    }
    ...
    remove(id)
    {
        this.players[id].oscillators.stop(clear = true);
